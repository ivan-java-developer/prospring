...
@Configuration
@EnableJpaRepositories(basePackages = {"com.prospring.ch11.repositories"})
@ComponentScan(basePackages = {"com.prospring.ch11"})
public class DataServiceConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.prospring.ch11");
